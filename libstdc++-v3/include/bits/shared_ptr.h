      ...
      template<typename _Vp, typename _Up>
        requires
          (__is_shared_ptr_v<_Vp> &&
           !__is_shared_ptr_v<_Up> &&
           !is_null_pointer_v<_Up> &&
           equality_comparable_with<typename _Vp::element_type*, _Up>)
        ...
        template<typename _Vp, typename _Up>
          requires
           (__is_shared_ptr_v<_Vp> &&
            !__is_shared_ptr_v<_Up> &&
            !is_null_pointer_v<_Up> &&
            three_way_comparable_with<typename _Vp::element_type*, _Up>)
        _GLIBCXX_NODISCARD friend inline
        compare_three_way_result_t<typename _Vp::element_type*, _Up>
